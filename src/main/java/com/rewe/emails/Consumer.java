...
public class Consumer {
    ...
    @KafkaListener(topics = "${kafka.topic.reweEmailsTopic}", groupId = "multiPartitionWith2Consumer")
    ...
    @KafkaListener(topics = "${kafka.topic.reweEmailsTopic}", groupId = "multiPartitionWithSingleConsumer6Thread")
